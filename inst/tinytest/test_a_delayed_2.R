...
expect_equal(sapply(dag$find_nodes_depending_directly_on(d), function(node) node$display_name), list())
expect_equal(sapply(dag$find_nodes_depending_directly_on(b), function(node) node$display_name), c("d"))
expect_equal(sapply(dag$find_nodes_depending_directly_on(c), function(node) node$display_name), c("d"))
expect_equal(sapply(dag$find_nodes_depending_directly_on(a), function(node) node$display_name), c("b", "c"))
