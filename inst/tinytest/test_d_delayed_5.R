...
# ----------------------------------------------------------------
a <- delayed(function()  { 9 },                  name='a', do_local=FALSE)
b <- delayed(function(x) { 11*x }, args=list(a), name='b', do_local=FALSE)
...
b <- delayed(function(x) {      1*x }, args=list(a), name='b', do_local=FALSE)
c <- delayed(function(x) {     10*x }, args=list(a), name='c', do_local=FALSE)
d <- delayed(function(x) {    100*x }, args=list(a), name='d', do_local=FALSE)
e <- delayed(function(x) {   1000*x }, args=list(a), name='e', do_local=FALSE)
f <- delayed(function(x) {  10000*x }, args=list(a), name='f', do_local=FALSE)
g <- delayed(function(x) { 100000*x }, args=list(a), name='g', do_local=FALSE)

h <- delayed(function(...) { sum(...) },   args=list(b,c,d,e,f,g),   name='h', do_local=FALSE)
