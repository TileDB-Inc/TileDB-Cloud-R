...
ArrayApi <- R6::R6Class(
  ...
  public = list(
    ...
    ArraysBrowserOwnedGet = function(page=NULL, per.page=NULL, search=NULL, namespace=NULL, orderby=NULL, permissions=NULL, tag=NULL, exclude.tag=NULL, file.type=NULL, exclude.file.type=NULL, ...){
      apiResponse <- self$ArraysBrowserOwnedGetWithHttpInfo(page, per.page, search, namespace, orderby, permissions, tag, exclude.tag, file.type, exclude.file.type, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    ArraysBrowserOwnedGetWithHttpInfo = function(page=NULL, per.page=NULL, search=NULL, namespace=NULL, orderby=NULL, permissions=NULL, tag=NULL, exclude.tag=NULL, file.type=NULL, exclude.file.type=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    ArraysBrowserPublicGet = function(page=NULL, per.page=NULL, search=NULL, namespace=NULL, orderby=NULL, permissions=NULL, tag=NULL, exclude.tag=NULL, file.type=NULL, exclude.file.type=NULL, ...){
      apiResponse <- self$ArraysBrowserPublicGetWithHttpInfo(page, per.page, search, namespace, orderby, permissions, tag, exclude.tag, file.type, exclude.file.type, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    ArraysBrowserPublicGetWithHttpInfo = function(page=NULL, per.page=NULL, search=NULL, namespace=NULL, orderby=NULL, permissions=NULL, tag=NULL, exclude.tag=NULL, file.type=NULL, exclude.file.type=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    ArraysBrowserSharedGet = function(page=NULL, per.page=NULL, search=NULL, namespace=NULL, orderby=NULL, permissions=NULL, tag=NULL, exclude.tag=NULL, file.type=NULL, exclude.file.type=NULL, ...){
      apiResponse <- self$ArraysBrowserSharedGetWithHttpInfo(page, per.page, search, namespace, orderby, permissions, tag, exclude.tag, file.type, exclude.file.type, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    ArraysBrowserSharedGetWithHttpInfo = function(page=NULL, per.page=NULL, search=NULL, namespace=NULL, orderby=NULL, permissions=NULL, tag=NULL, exclude.tag=NULL, file.type=NULL, exclude.file.type=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
