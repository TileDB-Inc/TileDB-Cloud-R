...
TasksApi <- R6::R6Class(
  ...
  public = list(
    ...
    TaskIdRetryPost = function(id, ...){
      apiResponse <- self$TaskIdRetryPostWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    TaskIdRetryPostWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    TasksGet = function(namespace=NULL, created.by=NULL, array=NULL, start=NULL, end=NULL, page=NULL, per.page=NULL, type=NULL, status=NULL, search=NULL, orderby=NULL, ...){
      apiResponse <- self$TasksGetWithHttpInfo(namespace, created.by, array, start, end, page, per.page, type, status, search, orderby, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    TasksGetWithHttpInfo = function(namespace=NULL, created.by=NULL, array=NULL, start=NULL, end=NULL, page=NULL, per.page=NULL, type=NULL, status=NULL, search=NULL, orderby=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
