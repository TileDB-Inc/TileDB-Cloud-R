...
##' TileDB Cloud Login-Reuse Helper
##'
##' This is a package-internal function. It returns the cached ApiClient object,
##' or stops. The ApiClient instance is constructor input to UserApi, ArrayApi, etc.
##' as generated by OpenAPI. Note that with in the OpenAPI autogen code, there is
##' the ApiClient instance which is used as constructor input to UserApi, ArrayApi,
##' UdfAPI, etc.
##'
##' @return The cached ApiClient object, or stops.
