...
ArrayInfoUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    `license_text` = NULL,
    initialize = function(
        `description`=NULL, `name`=NULL, `uri`=NULL, `file_type`=NULL, `file_properties`=NULL, `access_credentials_name`=NULL, `logo`=NULL, `tags`=NULL, `license_id`=NULL, `license_text`=NULL, ...
    ) {
