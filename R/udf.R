...
UDF <- R6::R6Class(
  ...
  public = list(
    ...
    `argument` = NULL,
    initialize = function(
        `udf_info_name`=NULL, `language`=NULL, `version`=NULL, `image_name`=NULL, `ranges`=NULL, `subarray`=NULL, `exec`=NULL, `exec_raw`=NULL, `buffers`=NULL, `result_format`=NULL, `task_name`=NULL, `argument`=NULL, ...
    ) {
    ...
    fromJSON = function(UDFJson) {
      ...
      if (!is.null(UDFObject$`argument`)) {
        self$`argument` <- UDFObject$`argument`
      }
      self
    },
    ...
    fromJSONString = function(UDFJson) {
      ...
      self$`version` <- UDFObject$`version`
      self$`image_name` <- UDFObject$`image_name`
      self$`ranges` <- QueryRanges$new()$fromJSON(jsonlite::toJSON(UDFObject$ranges, auto_unbox = TRUE, digits = NA))
