...
nodeGenerator$methods(
  ...
  # delayed function.
  compute = function(.self, namespace, timeout_seconds=120, verbose=FALSE) {
...
##' @export
compute <- function(object, namespace, timeout_seconds=120, verbose=FALSE) 0
setMethod("compute", signature(object = "Node"), function(object, namespace, timeout_seconds=120, verbose=FALSE) {
