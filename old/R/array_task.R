...
ArrayTask <- R6::R6Class(
  ...
  public = list(
    ...
    `logs` = NULL,
    initialize = function(
        `id`=NULL, `name`=NULL, `description`=NULL, `array_metadata`=NULL, `subarray`=NULL, `memory`=NULL, `cpu`=NULL, `namespace`=NULL, `status`=NULL, `start_time`=NULL, `finish_time`=NULL, `cost`=NULL, `query_type`=NULL, `udf_code`=NULL, `udf_language`=NULL, `sql_query`=NULL, `type`=NULL, `activity`=NULL, `logs`=NULL, ...
    ) {
