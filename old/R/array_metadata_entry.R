...
#'
#' @field value_num  integer [optional]
#'
...
ArrayMetadataEntry <- R6::R6Class(
  ...
  public = list(
    ...
    `del` = NULL,
    initialize = function(
        `key`=NULL, `type`=NULL, `value_num`=NULL, `value`=NULL, `del`=NULL, ...
    ) {
      ...
      if (!is.null(`value_num`)) {
        stopifnot(is.numeric(`value_num`), length(`value_num`) == 1)
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`value_num`)) {
        ArrayMetadataEntryObject[['value_num']] <-
          self$`value_num`
      }
    ...
    fromJSON = function(ArrayMetadataEntryJson) {
      ...
      if (!is.null(ArrayMetadataEntryObject$`value_num`)) {
        self$`value_num` <- ArrayMetadataEntryObject$`value_num`
      }
